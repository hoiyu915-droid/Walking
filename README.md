...
- `notes/20260707_215111__gait_fascia_metabolism/00_index.md`

## Topic files

1. `01_gait_energy_transfer.md` — 步行不是單肌肉收縮，而是筋腱、筋膜、骨盆、軀幹、足部的能量傳播系統。
2. `02_high_load_mobility_threshold.md` — 為何有些活動度需要足夠大的重量才會打開。
3. `03_pelvic_control_glute_activation.md` — 重訓作為骨盆控制重建；臀大肌/臀中肌喚醒不是屁股有感，而是骨盆承重與傳力上線。
4. `04_fascia_ecm_interface_restriction.md` — 「微型黏連」較穩的語言：ECM 緻密化、界面滑動受限、微纖維 tethering。
